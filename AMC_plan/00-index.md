...
- 轨迹路径归档在 `ctx://agent/{agent_id}/memories/trajectories/`。
...
| [05-multitenancy-and-access-control.md](05-multitenancy-and-access-control.md) | 多租户与权限 | tenant/agent 隔离、ACL、审计、字段脱敏 |
